...
-- =============================================================================
-- Provides better search using PostgreSQL's full-text search capabilities

-- Function to search listings with ranking
...
BEGIN
  ...
  ORDER BY
    -- Featured listings first (if not searching)

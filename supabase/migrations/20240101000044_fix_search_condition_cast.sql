-- =============================================================================
-- Fix: search_listings Enum-Cast fuer listing_condition und listing_status
-- Problem: "operator does not exist: listing_condition = text"
--          "Returned type listing_status does not match expected type text"
-- Loesung: Expliziter Cast von Enum-Spalten zu TEXT im SELECT
-- =============================================================================

-- Bestehende Funktion droppen

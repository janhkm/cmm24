...
export async function generateMetadata({ params }: RatgeberDetailPageProps): Promise<Metadata> {
  ...
  if (!article) {
    return {
      title: 'Artikel nicht gefunden | CMM24',
    };
  }

  return {
    title: `${article.title} | Ratgeber | CMM24`,
        ...
        <div className="container-page">
          ...
          <nav className="mb-6" aria-label="Breadcrumb">
            <ol className="flex items-center gap-2 text-sm text-muted-foreground">
              ...
              <li>/</li>
              <li><Link href="/ratgeber" className="hover:text-foreground">Ratgeber</Link></li>
              <li>/</li>
          ...
          <article className="max-w-4xl mx-auto">
            ...
            <header className="mb-8">
              <Badge variant="secondary" className="mb-4">
                {article.category === 'kaufratgeber' && 'Kaufratgeber'}
                {article.category === 'vergleich' && 'Vergleich'}
                {article.category === 'technik' && 'Technik'}
                {article.category === 'markt' && 'Markt'}
              </Badge>
            ...
            <div className="mt-8 p-6 bg-primary text-primary-foreground rounded-xl text-center">
              <h3 className="text-xl font-bold mb-2">Passende Maschine finden?</h3>
              <p className="opacity-90 mb-4">
                Stöbern Sie in unserem Angebot gebrauchter Koordinatenmessmaschinen.
              </p>
